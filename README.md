...
├── Dockerfile
├── requirements.txt                      
|___ .env                             # Environment variable template
└── README.md
```
...
```bash
cd src
uvicorn main:app --host localhost --port your_port --reload
```

Server will be available at: `http://localhost:your_port`  
Swagger UI: `http://localhost:your_port/docs`  
Health check: `http://localhost:your_port/health`
...
INTENT_ROUTER_PROVIDER=your_provider
...
LANGFUSE_HOST=http://localhost:your_port

# ── Redis ─────────────────────────────────────────────────────────────────────
REDIS_HOST=localhost
REDIS_PORT=youryour_port
```
